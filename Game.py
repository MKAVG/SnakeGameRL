...
class SnakeGame:
    def __init__(self, rows=10, cols=10): #done
        self.clock = pygame.time.Clock()
        self.timex = pygame.time.get_ticks()
    ...
    def printStatus(self):  #done
        self.snake.printSnake()
        self.map.printMap()
        print("\n")

    def play(self,display=True):  #done
        i = 0
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_UP:
                        self.addTurn(self.directions.UP)
                    elif event.key == pygame.K_DOWN:
                        self.addTurn(self.directions.DOWN)
                    elif event.key == pygame.K_LEFT:
                        self.addTurn(self.directions.LEFT)
                    elif event.key == pygame.K_RIGHT:
                        self.addTurn(self.directions.RIGHT)
    ...
    def updateSize(self):   #done
        if self.snake.bodyLocations[0] == list(self.map.food):
            ...
            if self.snake.bodyDirections[len(self.snake.bodyLocations)-1] == self.directions.UP:
                newBody[1] += 1
            elif self.snake.bodyDirections[len(self.snake.bodyLocations)-1] == self.directions.DOWN:
                newBody[1] -= 1
            elif self.snake.bodyDirections[len(self.snake.bodyLocations)-1] == self.directions.LEFT:
                newBody[0] += 1
            elif self.snake.bodyDirections[len(self.snake.bodyLocations)-1] == self.directions.RIGHT:
                newBody[0] -= 1
    ...
    def generateFoodFront(self):  #done
        newFood = copy.deepcopy(self.snake.bodyLocations[0])
        if self.snake.bodyDirections[0] == self.directions.UP:
            newFood[1] -= 1
        elif self.snake.bodyDirections[0] == self.directions.DOWN:
            newFood[1] += 1
        elif self.snake.bodyDirections[0] == self.directions.LEFT:
            newFood[0] -= 1
        elif self.snake.bodyDirections[0] == self.directions.RIGHT:
            newFood[0] += 1
        self.map.food = tuple(newFood)